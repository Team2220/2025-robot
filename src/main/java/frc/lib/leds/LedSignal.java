...
public class LedSignal {
  ...
  public static LedSignal hasActiveFault() {
    // blink orange
    StrobeAnimation strobeAnimation = new StrobeAnimation(255, 165, 0, 0, 0.1, 164);
    return new LedSignal("hasActiveFault", FaultRegistry::hasAnyActive, strobeAnimation, 0);
  }

  private static TunableDouble endgameTimeStart =
      new TunableDouble("EndgameTimeStart", 15, true, "LEDs");
  private static TunableDouble endgameTimeEnd =
      new TunableDouble("EndgameTimeEnd", 15, true, "LEDs");
