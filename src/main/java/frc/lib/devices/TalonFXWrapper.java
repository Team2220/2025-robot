...
public class TalonFXWrapper implements ShuffleBoardTabWrapper {
  ...
  private TunableMeasure<CurrentUnit> stallCurrentLimit;
  private TunableMeasure<AngularVelocityUnit> stallRotationLimit;
  ...
  public TalonFXWrapper(int id, String name, boolean isInverted, NeutralModeValue neutralMode,
    ...
    talonFXConfigs.SoftwareLimitSwitch.ForwardSoftLimitThreshold =
        forwardSoftLimitTreshold.in(Rotations);
    talonFXConfigs.SoftwareLimitSwitch.ReverseSoftLimitThreshold =
        reverseSoftLimitThreshold.in(Rotations);
    ...
    this.stallCurrentLimit =
        new TunableMeasure<>("Stall Current Threshold", stallCurrentThreshold, getName());
    this.stallRotationLimit =
        new TunableMeasure<>("Stall Rotation Threshold", stallRotationThreshold, getName());
