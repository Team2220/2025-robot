...
public class DriveConstants {
  ...
  public static class Real {
    ...
    public static final Slot0Configs DRIVE_GAINS = new Slot0Configs().withKP(0.1).withKI(0).withKD(0).withKS(0.10413)
        .withKV(0.68850);
  }
  ...
  private static final double kDriveGearRatio = 6.122; // Source: MK4i swerve module page; L3 gearing
